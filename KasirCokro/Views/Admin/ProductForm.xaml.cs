...
namespace KasirCokro.Views.Admin
{
    public partial class ProductForm : Window
    {
        ...
        public ProductForm(Product product)
        {
            ...
            // Calculate percentage initially
            CalculatePercentage();
        }
        ...
        private void BtnSimpan_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                // Parse dan validasi nilai input
                ...
                // Hitung pendapatan otomatis (bisa disesuaikan dengan logika bisnis)
                ...
                // Get calculated percentage (remove % sign and convert to decimal)
                ...
                using (MySqlConnection conn = Helpers.DatabaseHelper.GetConnection())
                {
                    ...
                    {
                        // Update data lama - PERBAIKAN: Semua field harus ada dalam SET clause
